...
Move on to [Run basic process]({{ site.baseurl }}/pages/snakemake/03_run_basic_processs.html), or back to [Run basic process]({{ site.baseurl }}/pages/snakemake/03_run_basic_processs.html).
